...
AdminOrder.prototype = {
	...
	qtyvalidation : function(id){
	  
	    var elm = $('element'+id);

		if(parseInt(elm.value) > parseInt(elm.getAttribute('maxqty'))){
			alert('Max Quantity allowed : '+ parseInt(elm.getAttribute('maxqty')));
			elm.value = parseInt(elm.getAttribute('maxqty'));
